          ...
          <div class="row">
             ...
             <div class="col-md-6">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="receiveOffers">I Want To Receive Exclusive Offers From LeisureGuider.com.</label>
                </div>

                <button type="submit" class="btn btn-orange btn-block">SIGN UP</button>
                <div class="mb-3">
                  <small>By Clicking “SIGN UP”, I agree to LeisureGuider's
