...
<section class="top-banner bg-light my-0 py-2">
  <div class="container-fluid">
      <ul class="top-banner-list small">
        <li>
          <a href="call:4222022">Call Us : +9476 183 0 736</a>
        </li>
        <li>
        ...
        <li class="active">
          <a href="{{route('myOrder.index')}}">Track Your Order</a>
        </li>
      </ul>
  </div>
</section>
          ...
          <div class="row align-items-center">
              <div class="col-lg-3 col-sm-6 col-md-3 col-5"> 
                <a href="{{route('shop.index')}}" class="brand-wrap" data-abc="true">
                      <img class="logo" width="50px" src="{{asset('50by50.png')}}">
                      <span class="logo">LeisureGuider.com</span>
                </a> </div>
              ...
              <div class="col-lg-3 col-sm-6 col-md-3 col-xl-4 col-7">
                  <div class="d-flex justify-content-end">
                    ...
                    <a class="nav-link nav-user-img text-white" href="{{route('user.index')}}">Account</a>
                          <a class="nav-link nav-user-img text-white" href="#">Guiding</a>
                          <a class="nav-link nav-user-img text-white" href="#">Blog</a>
